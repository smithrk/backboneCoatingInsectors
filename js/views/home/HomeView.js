...
define([
  ...
  'text!templates/home/slideshowTemplate.html'

], function($, _, Backbone, ProjectGridView, homeTemplate, movieSearchFormTemplate, slideshow){

  var HomeView = Backbone.View.extend({
    el: $("#page"),
    render: function(){
        // display home template to the defined element "el"
        this.$el.html(slideshow + homeTemplate);   
